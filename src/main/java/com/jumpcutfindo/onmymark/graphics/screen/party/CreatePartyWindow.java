...
public class CreatePartyWindow extends OnMyMarkWindow {
    ...
    public static final int WINDOW_WIDTH = 138, WINDOW_HEIGHT = 121;
    ...
    public CreatePartyWindow(OnMyMarkScreen screen) {
        ...
        this.submitButton = new OnMyMarkButton(0, 0, 64, 20, Text.translatable("microchip.menu.createParty.submitButton"), (widget) -> {
            this.createParty();
